	...
	<div id='main_content'>
		...
		<div id="content">
			...
			<div class="outer_frame" style="height: 22.5rem">
				<div class="content_title">12月&nbsp2019閩南文化國際學術研討會</div>
				<img class="poster_img" id="poster1" src="img/activity/poster2019.jpg" onclick="show_poster(this.id)"></img>
				<div class="inner_frame" style="height: 14rem">
					主辦單位:&nbsp金門縣文化局<br><br>
					承辦單位:&nbsp國立成功大學中國文學系<br><br>
					合辦單位:&nbsp國立金門大學人文社會學院閩南文化碩士學位學程<br><br>
					協辦單位:&nbsp金門縣閩南文化協會、府城觀興文化藝術基金會<br><br>
					日期:&nbsp2019.12.06
				</div>
			</div>
